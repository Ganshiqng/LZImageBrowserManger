...
#import "LZImageBrowser/LZImageBrowserHeader.h"
...
#warning 有时候图片的链接地址会无效，更换为有效的链接地址即可
    ...
    //初始化 manger
    LZImageBrowserManger *imageBrowserManger = [LZImageBrowserManger imageBrowserMangerWithUrlStr:bigImages originImageViews:originImageViews originController:self forceTouchActionTitles:@[@"赞", @"评论", @"收藏"] forceTouchActionComplete:^(NSInteger selectIndex, NSString *title) {
